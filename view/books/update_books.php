...
<hr>
<form action="../../controller/books/update_book.php" method="POST" >
	<div >
		<input type="hidden" name="txtId" value="<?php echo($txtId) ?>"><br>
		<label >Name :</label><br>
		<input type="text" name="txtName" value="<?php echo($txtName) ?>"><br>
		<label >Author :</label><br>
		<input type="text" name="txtAuthor" value="<?php echo($txtAuthor) ?>"><br>
		<label >Category :</label><br>
		<input type="text" name="txtCategory" value="<?php echo($txtCategory) ?>"><br>
		<label >Qty :</label><br>
		<input type="text" disabled="disabled" name="txtQty" value="<?php echo($txtQty) ?>">
		<br>
		<input type="submit" name="btnAdd" value="Update Book Details">
	</div>
</form>
